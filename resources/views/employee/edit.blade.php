        ...
        <div class=" col-lg-12">
            ...
            <form method="post" action="{{route("customer.update",$data->id)}}">
                ...
                <div class="form-group">
                    ...
                    <input name="address" type="text" value="{{$data->address}}" class="form-control" id="address" aria-describedby="emailHelp"
                           placeholder="Address" required>
                    <small id="emailHelp" class="form-text text-danger">This field is required</small>
                </div>
                <div class="form-group">
                    <label for="phone">Phone</label>
                    <input name="phone" type="text" value="{{$data->phone}}" class="form-control" id="phone" aria-describedby="emailHelp"
