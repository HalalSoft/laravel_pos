...
<head>
    ...
    <title>@yield('title') - POS Waserda</title>

    @include("layouts.vendorstyle")
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
            ...
            <div class="sidebar-brand-text mx-3">POS Waserda</div>
        </a>
        ...
        @endif
    <!-- Nav Item - Tables -->
        @if(in_array($role,['Admin','Director','Cashier']))
            <li class="nav-item">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; POS WASERDA 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
